...
class CursorAnimation {
    ...
    update(mouseX, mouseY) {
        ...
        this.cursor.element.style.borderColor = `rgb(${this.cursor.color.r}, ${this.cursor.color.g}, ${this.cursor.color.b}`;
        ...
        if(this.cursor.target == 'NotOnScreen') {
            ...
            this.cursor.colorBgHover = {r: 255, g:255, b:255, a: 0.2};
        } else {
            this.cursor.scaleHover = 0.2;
            this.cursor.colorHover = {r: 255, g:255, b:255};
            this.cursor.colorBgHover = {r: 255, g:255, b:255};
            this.cursor.colorBgHover = {r: 255, g:255, b:255, a: 1};
